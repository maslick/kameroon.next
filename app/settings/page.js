              ...
              <div className="space-y-3">
                ...
                {settings.crossHair && (
                  <div className="flex items-center justify-center pt-8">
                    <select
                      className="w-[200px] bg-gray-50 border border-gray-300 text-gray-900 text-pretty rounded-lg focus:ring-green-500 focus:border-green-500 p-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 appearance-none "
